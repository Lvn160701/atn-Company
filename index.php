              ...
              <div class="header_bottom">
                <ul class="option">
                  ...
                  <li class="option-cart">
                    <a href="#" class="cart-icon"
                      >cart <span class="cart_no">02</span></a
                    >
                    <ul class="option-cart-item">
                      <li>
                        <div class="cart-item">
                          ...
                          <div class="item-description">
                            ...
                            <p>
                              Size: <span class="light-red">One size</span
                              ><br />Quantity: <span class="light-red">01</span>
                            </p>
                          </div>
                          <div class="right">
                      ...
                      <li>
                        <span class="total">Total <strong>$60.00</strong></span
                        ><button
                          class="checkout"
                ...
                <div class="navbar-collapse collapse">
                  <ul class="nav navbar-nav">
                    ...
                    <li><a href="productgird.html">boy toys</a></li>
                    <li><a href="productlitst.html">female toys</a></li>
                    <li class="dropdown">
                      <a href="#" class="dropdown-toggle" data-toggle="dropdown"
                        >Fashion</a
                      >
          ...
          <div id="sequence">
            ...
            <ul class="sequence-canvas">
              <li class="animate-in">
                ...
                <div
                  class="flat-image formBottom delay200"
                  data-duration="5"
                  data-bottom="true"
                >
          ...
          <div class="container">
            <div class="row">
              <div class="col-md-4 col-sm-4 col-xs-4">
                <div class="promo-box">
                  <img src="images/promotion-01.jpg" alt="" />
                </div>
              </div>
              <div class="col-md-4 col-sm-4 col-xs-4">
                <div class="promo-box">
                  <img src="images/promotion-02.jpg" alt="" />
                </div>
              </div>
              <div class="col-md-4 col-sm-4 col-xs-4">
                <div class="promo-box">
                  <img src="images/promotion-03.jpg" alt="" />
                </div>
              </div>
            </div>
          </div>
                ...
                <div class="row">
                  <div class="col-md-3 col-sm-6">
                    <div class="products">
                      ...
                      <div class="productname">Children toy</div>
          ...
          <div class="container">
            <div class="row">
              ...
              <div class="col-md-3 col-sm-6">
                ...
                <p>No. 63 Tran Quoc Vuong, Ha Noi</p>
                <p>Call Us : (084) 946445089</p>
                <p>Email : nhatlvbhaf190185@fpt.edu</p>
              </div>
              <div class="col-md-3 col-sm-6">
